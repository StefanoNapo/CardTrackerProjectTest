...
class CardRepository @Inject constructor(
    ...
    suspend fun getAllCardsMyColl(): List<MyCollectionEntity> {
        val response = cardDao.getAllCardsMyColl()
    ...
    suspend fun getAllCardsCompColl(): List<CompetitiveCollectionEntity> {
        val response = cardDao.getAllCardsCompColl()
        return response.map { it }
    }
    ...
    suspend fun searchCardsNameMyColl(searchQuery: String): List<MyCollectionEntity> {
        val response = cardDao.searchCardsNameMyColl(searchQuery)
        return response.map { it }
    }
    ...
    suspend fun searchCardsNameCompColl(searchQuery: String): List<CompetitiveCollectionEntity> {
        val response = cardDao.searchCardsNameCompColl(searchQuery)
        return response.map { it }
    }
    ...
    suspend fun searchCardsNameWithTypeMonType(
        searchQuery: String,
        searchType: String,
        monsType: String
    ): List<Card> {
    ...
    suspend fun searchCardsNameWithTypeAttr(
        searchQuery: String,
        searchType: String,
        searchAttr: String
    ): List<Card> {
    ...
    suspend fun searchCardsNameWithMonTypeAttr(
        searchQuery: String,
        monsType: String,
        searchAttr: String
    ): List<Card> {
    ...
    suspend fun searchCardsNameWithTypeAtk(
        searchQuery: String,
        searchType: String,
        searchAtk: Int
    ): List<Card> {
    ...
    suspend fun searchCardsNameWithTypeDef(
        searchQuery: String,
        searchType: String,
        searchDef: Int
    ): List<Card> {
    ...
    suspend fun searchCardsNameWithTypeLvl(
        searchQuery: String,
        searchType: String,
        searchLvl: Int
    ): List<Card> {
    ...
    suspend fun searchCardsNameWithMonTypeAtk(
        searchQuery: String,
        monsType: String,
        searchAtk: Int
    ): List<Card> {
    ...
    suspend fun searchCardsNameWithMonTypeDef(
        searchQuery: String,
        monsType: String,
        searchDef: Int
    ): List<Card> {
    ...
    suspend fun searchCardsNameWithMonTypeLvl(
        searchQuery: String,
        monsType: String,
        searchLvl: Int
    ): List<Card> {
    ...
    suspend fun searchCardsNameWithAttrAtk(
        searchQuery: String,
        searchAttr: String,
        searchAtk: Int
    ): List<Card> {
    ...
    suspend fun searchCardsNameWithAttrDef(
        searchQuery: String,
        searchAttr: String,
        searchDef: Int
    ): List<Card> {
    ...
    suspend fun searchCardsNameWithAttrLvl(
        searchQuery: String,
        searchAttr: String,
        searchLvl: Int
    ): List<Card> {
    ...
    suspend fun searchCardsNameWithAtkDef(
        searchQuery: String,
        searchDef: Int,
        searchAtk: Int
    ): List<Card> {
    ...
    suspend fun searchCardsNameWithAtkLvl(
        searchQuery: String,
        searchLvl: Int,
        searchAtk: Int
    ): List<Card> {
    ...
    suspend fun searchCardsNameWithDefLvl(
        searchQuery: String,
        searchDef: Int,
        searchLvl: Int
    ): List<Card> {
    ...
    suspend fun searchCardsWithTypeAttrMonType(
        ...
        val response =
            cardDao.searchCardsWithTypeAttrMonType(searchQuery, searchType, searchAttr, monsType)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithTypeMonTypeAtk(
        ...
        val response =
            cardDao.searchCardsWithTypeMonTypeAtk(searchQuery, searchType, monsType, searchAtk)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithTypeMonTypeDef(
        ...
        val response =
            cardDao.searchCardsWithTypeMonTypeDef(searchQuery, searchType, monsType, searchDef)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithTypeMonTypeLvl(
        ...
        val response =
            cardDao.searchCardsWithTypeMonTypeLvl(searchQuery, searchType, monsType, searchLvl)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithTypeAttrAtk(
        ...
        val response =
            cardDao.searchCardsWithTypeAttrAtk(searchQuery, searchType, searchAttr, searchAtk)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithTypeAttrDef(
        ...
        val response =
            cardDao.searchCardsWithTypeAttrDef(searchQuery, searchType, searchAttr, searchDef)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithTypeAttrLvl(
        ...
        val response =
            cardDao.searchCardsWithTypeAttrLvl(searchQuery, searchType, searchAttr, searchLvl)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithTypeAtkDef(
        ...
        val response =
            cardDao.searchCardsWithTypeAtkDef(searchQuery, searchType, searchAtk, searchDef)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithTypeAtkLvl(
        ...
        val response =
            cardDao.searchCardsWithTypeAtkLvl(searchQuery, searchType, searchAtk, searchLvl)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithTypeDefLvl(
        ...
        val response =
            cardDao.searchCardsWithTypeDefLvl(searchQuery, searchType, searchDef, searchLvl)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithMonTypeAttrAtk(
        ...
        val response =
            cardDao.searchCardsWithMonTypeAttrAtk(searchQuery, monsType, searchAttr, searchAtk)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithMonTypeAttrDef(
        ...
        val response =
            cardDao.searchCardsWithMonTypeAttrDef(searchQuery, monsType, searchAttr, searchDef)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithMonTypeAttrLvl(
        ...
        val response =
            cardDao.searchCardsWithMonTypeAttrLvl(searchQuery, monsType, searchAttr, searchLvl)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithMonTypeAtkDef(
        ...
        val response =
            cardDao.searchCardsWithMonTypeAtkDef(searchQuery, monsType, searchAtk, searchDef)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithMonTypeAtkLvl(
        ...
        val response =
            cardDao.searchCardsWithMonTypeAtkLvl(searchQuery, monsType, searchAtk, searchLvl)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithMonTypeDefLvl(
        ...
        val response =
            cardDao.searchCardsWithMonTypeDefLvl(searchQuery, monsType, searchDef, searchLvl)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithAttrAtkDef(
        ...
        val response =
            cardDao.searchCardsWithAttrAtkDef(searchQuery, searchAttr, searchAtk, searchDef)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithAttrAtkLvl(
        ...
        val response =
            cardDao.searchCardsWithAttrAtkLvl(searchQuery, searchAttr, searchAtk, searchLvl)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithAttrDefLvl(
        ...
        val response =
            cardDao.searchCardsWithAttrDefLvl(searchQuery, searchAttr, searchDef, searchLvl)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithAtkDefLvl(
        ...
        val response =
            cardDao.searchCardsWithAtkDefLvl(searchQuery, searchAtk, searchDef, searchLvl)
        return response.map { it.toDomain() }
    }
    ...
    suspend fun searchCardsWithTypeMonTypeAttrAtk(
        ...
        val response = cardDao.searchCardsWithTypeMonTypeAttrAtk(
            searchQuery,
            searchType,
            monsType,
            searchAttr,
    ...
    suspend fun searchCardsWithTypeMonTypeAttrDef(
        ...
        val response = cardDao.searchCardsWithTypeMonTypeAttrDef(
            searchQuery,
            searchType,
            monsType,
            searchAttr,
    ...
    suspend fun searchCardsWithTypeMonTypeAttrLvl(
        ...
        val response = cardDao.searchCardsWithTypeMonTypeAttrLvl(
            searchQuery,
            searchType,
            monsType,
            searchAttr,
    ...
    suspend fun searchCardsWithTypeMonTypeAtkDef(
        ...
        val response = cardDao.searchCardsWithTypeMonTypeAtkDef(
            searchQuery,
            searchType,
            monsType,
            searchAtk,
    ...
    suspend fun searchCardsWithTypeMonTypeAtkLvl(
        ...
        val response = cardDao.searchCardsWithTypeMonTypeAtkLvl(
            searchQuery,
            searchType,
            monsType,
            searchAtk,
    ...
    suspend fun searchCardsWithTypeMonTypeDefLvl(
        ...
        val response = cardDao.searchCardsWithTypeMonTypeDefLvl(
            searchQuery,
            searchType,
            monsType,
            searchDef,
    ...
    suspend fun searchCardsWithTypeAttrAtkDef(
        ...
        val response = cardDao.searchCardsWithTypeAttrAtkDef(
            searchQuery,
            searchType,
            searchAttr,
            searchAtk,
    ...
    suspend fun searchCardsWithTypeAttrAtkLvl(
        ...
        val response = cardDao.searchCardsWithTypeAttrAtkLvl(
            searchQuery,
            searchType,
            searchAttr,
            searchAtk,
    ...
    suspend fun searchCardsWithTypeAttrDefLvl(
        ...
        val response = cardDao.searchCardsWithTypeAttrDefLvl(
            searchQuery,
            searchType,
            searchAttr,
            searchDef,
    ...
    suspend fun searchCardsWithTypeAtkDefLvl(
        ...
        val response = cardDao.searchCardsWithTypeAtkDefLvl(
            searchQuery,
            searchType,
            searchAtk,
            searchDef,
    ...
    suspend fun searchCardsWithMonTypeAttrAtkDef(
        ...
        val response = cardDao.searchCardsWithMonTypeAttrAtkDef(
            searchQuery,
            monsType,
            searchAttr,
            searchAtk,
    ...
    suspend fun searchCardsWithMonTypeAttrAtkLvl(
        ...
        val response = cardDao.searchCardsWithMonTypeAttrAtkLvl(
            searchQuery,
            monsType,
            searchAttr,
            searchAtk,
    ...
    suspend fun searchCardsWithMonTypeAttrDefLvl(
        ...
        val response = cardDao.searchCardsWithMonTypeAttrDefLvl(
            searchQuery,
            monsType,
            searchAttr,
            searchDef,
    ...
    suspend fun searchCardsWithMonTypeAtkDefLvl(
        ...
        val response = cardDao.searchCardsWithMonTypeAtkDefLvl(
            searchQuery,
            monsType,
            searchAtk,
            searchDef,
    ...
    suspend fun searchCardsWithAttrAtkDefLvl(
        ...
        val response = cardDao.searchCardsWithAttrAtkDefLvl(
            searchQuery,
            searchAttr,
            searchAtk,
            searchDef,
    ...
    suspend fun searchCardsWithTAMTAtkD(
        ...
        val response = cardDao.searchCardsWithTAMTAtkD(
            searchQuery,
            searchType,
            searchAttr,
            monsType,
    ...
    suspend fun searchCardsWithTAMTAtkL(
        ...
        val response = cardDao.searchCardsWithTAMTAtkL(
            searchQuery,
            searchType,
            searchAttr,
            monsType,
    ...
    suspend fun searchCardsWithTAMTDL(
        ...
        val response = cardDao.searchCardsWithTAMTDL(
            searchQuery,
            searchType,
            searchAttr,
            monsType,
    ...
    suspend fun searchCardsWithTAAtkDL(
        ...
        val response = cardDao.searchCardsWithTAAtkDL(
            searchQuery,
            searchType,
            searchAttr,
            searchAtk,
    ...
    suspend fun searchCardsWithTMTAtkDL(
        ...
        val response = cardDao.searchCardsWithTMTAtkDL(
            searchQuery,
            searchType,
            monsType,
            searchAtk,
    ...
    suspend fun searchCardsWithMTAAtkDL(
        ...
        val response = cardDao.searchCardsWithMTAAtkDL(
            searchQuery,
            monsType,
            searchAttr,
            searchAtk,
    ...
    suspend fun searchCardsWithTAMTAtkDL(
        ...
        val response = cardDao.searchCardsWithTAMTAtkDL(
            searchQuery,
            searchType,
            searchAttr,
            monsType,
